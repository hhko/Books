...
## 목차
1. [Introduction](./Ch01_Introduction)
   - Encapsulation 목표
   - Mutable Anemic Domain Model vs. Immutable Anemic Domain Model 차이점
1. [Introducing an Anemic Domain Model](./Ch02_Introducing an Anemic Domain Model)
   - 예제 프로그램 Domain Model 소개
1. [Decoupling the Domain Model from Data Contracts](./Ch03_Decoupling the Domain Model from Data Contracts)
   - Data Contracts 필요성
   - Data Contracts 구현 방법(DTO : Data Transfer Objects)
1. [Using Value Objects as Domain Model Building Blocks](./Ch04_Using Value Objects as Domain Model Building Blocks)
